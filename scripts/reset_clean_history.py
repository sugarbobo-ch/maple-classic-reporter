...
HISTORY_FILE.write_text(json.dumps(clean_user_history, ensure_ascii=False, indent=2), encoding="utf-8")

LEGACY_HISTORY_FILE.parent.mkdir(parents=True, exist_ok=True)
LEGACY_HISTORY_FILE.write_text(json.dumps(clean_user_history, ensure_ascii=False, indent=2), encoding="utf-8")

print("Reset history.json to clean un-synced raw records successfully.")
