...
# 1. Fetch Classic bulletin list from maplestoryclassic.beanfun.com
...
print(f"Total Classic sanction bulletins found: {len(sanction_bids)}")
for bid, date, title in sanction_bids:
    print(f"  {date} [Bid {bid}]: {title}")

# 2. Fetch detail using maplestory.beanfun.com/bulletin?handler=BulletinDetail
if sanction_bids:
